...
function Setup(props: any) {
  ...
  const presetLabel = props.preset === "react" ? "React" : props.preset === "preact" ? "Preact" : props.preset === "jsx" ? "JSX/TSX" : "";
